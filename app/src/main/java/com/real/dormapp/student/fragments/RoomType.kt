package com.real.dormapp.student.fragments
...
import com.real.dormapp.student.StudentDashboard.Companion.roomType
        ...
        nextButton.setOnClickListener() {
            ...
            if (selectId == -1) {
                ...
                requireActivity().supportFragmentManager.beginTransaction()
                    .replace(R.id.fragment_container, seaterFragment).commit()
